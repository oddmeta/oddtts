...
SAMPLE_RATE = 44100
ONNX_MODEL_DIR = resolve_model_dir(ODDTTS_TYPE.ODDTTS_AUDIO8_0_6B_ONNX_INT4.model_key, env_var="AUDIO8_0_6B_MODEL_DIR")
...
class Audio8_0_6b_OnnxInt4_API:
    ...
    def _init_runtime(self):
        ...
        try:
            ...
            logger.info(f"[Audio8-0.6B] Runtime 初始化成功，采样率: {self.runtime.manifest['sample_rate']} Hz, threads: {oddtts_cfg['concurrent_thread']}")
        except Exception as e:
    ...
    def _register_voice(self, voice_name: str, audio_path: str, reference_text: str = "") -> bool:
        ...
        try:
            reg = VoiceRegistration(
                model_dir=Path(ONNX_MODEL_DIR) / "registration",
